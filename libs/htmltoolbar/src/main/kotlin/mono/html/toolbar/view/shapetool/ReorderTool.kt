...
private enum class IconType(val actionType: OneTimeActionType, val iconPaths: List<String>) {
    FRONT(
        OneTimeActionType.MOVE_SELECTED_SHAPE_FRONT,
        listOf(
